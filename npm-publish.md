...
matches `package.json` exactly. For `0.2.6`, the release tag must be `v0.2.6`
and must contain assets named like:

```text
anveesa-0.2.6-aarch64-apple-darwin.tar.gz
anveesa-0.2.6-x86_64-apple-darwin.tar.gz
anveesa-0.2.6-x86_64-unknown-linux-gnu.tar.gz
anveesa-0.2.6-aarch64-unknown-linux-gnu.tar.gz
anveesa-0.2.6-x86_64-pc-windows-msvc.tar.gz
```
